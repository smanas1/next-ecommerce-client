...
const mockFeaturedProducts: Product[] = [
  {
    ...
    category: "Outerwear",
    images: [
      "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=1974&auto=format&fit=crop",
    ],
    rating: 4.8,
  },
  {
  ...
  },
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1491637639811-60e2756cc1c7?q=80&w=2070&auto=format&fit=crop",
    ],
    rating: 4.6,
  },
];
...
async function fetchBanners(): Promise<Banner[]> {
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/settings/get-banners`,
      {
      ...
      return [
        {
          id: "1",
          imageUrl:
            "https://images.unsplash.com/photo-1603076564521-360ea6c78ada?q=80&w=2074&auto=format&fit=crop",
        ...
        },
        {
          id: "2",
          imageUrl:
            "https://images.unsplash.com/photo-1520509454706-f3b657c4b39b?q=80&w=2070&auto=format&fit=crop",
...
// Function to create dummy products for non-logged-in users
function createDummyProducts(): Product[] {
  return [
    ...
    },
    {
      ...
      category: "Bottoms",
      images: [
        "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=400&auto=format&fit=crop&q=60",
      ],
      rating: 4.6,
    },
    {
      ...
      name: "Classic Jacket",
      price: 149.99,
      description: "Elegant jacket for any occasion",
      category: "Outerwear",
      images: [
        "https://images.unsplash.com/photo-1551028719-00167b16eac5?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      ],
      rating: 4.8,
    },
  ];
...
async function fetchFeaturedProducts(isLoggedIn: boolean): Promise<Product[]> {
  if (!isLoggedIn) {
    // Return dummy products for non-logged-in users
    return createDummyProducts();
  }

  try {
    // For logged-in users, try to fetch actual featured products from the server API
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/settings/fetch-feature-products`,
      {
        cache: "no-store", // This ensures fresh data on each request
        credentials: "include", // Include authentication cookies
      }
    ...
    if (!response.ok) {
      ...
      // Return dummy products if API call fails for logged-in users too
      return createDummyProducts();
    }
    ...
    // If no featured products are returned from the API, use dummy products
    ...
    // Return dummy products if there's a network error
    return createDummyProducts();
  }
}

function HomePage() {
  const { user, isLoading: authLoading } = useAuthStore(); // Get user from auth store
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch different banners based on auth status
        let bannersData: Banner[] = [];

        if (user) {
          // For logged-in users, fetch personalized banners from API
          bannersData = await fetchBanners();
        } else {
          // For non-logged-in users, use static unsplash images
          bannersData = [
            {
              id: "1",
              imageUrl:
                "https://images.unsplash.com/photo-1607082350899-7e105aa886ae?w=1200&auto=format&fit=crop&q=60",
            ...
            },
            {
              id: "2",
              imageUrl:
                "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=1200&auto=format&fit=crop&q=60",
              title: "PREMIUM FASHION",
              subtitle: "Quality materials & design",
            },
            {
              id: "3",
              imageUrl:
                "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&auto=format&fit=crop&q=60",
              title: "EXCLUSIVE OFFERS",
              subtitle: "Special discounts for new customers",
            },
          ];
        }

        const featuredProductsData = await fetchFeaturedProducts(!!user);
            ...
            <div className="relative h-full max-w-7xl mx-auto px-6 flex items-center">
              <div className="text-white max-w-2xl space-y-8">
                ...
                <p className="text-lg text-gray-200">
                  {bannerItem.subtitle}. Discover our curated collection of
                  premium fashion items designed to enhance your personal style
      ...
      <section className="py-8 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60">
            {["VERSACE", "GUCCI", "PRADA", "CHANEL", "DIOR", "HERMES"].map(
              (brand, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Explore our carefully selected collections to find the perfect
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Check out our latest additions to the collection. Fresh styles for
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mt-3 mb-4">
                    {productItem.description.substring(0, 80)}...
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Discover what's hot in the fashion world right now. These items
              are flying off our virtual shelves.
            </p>
          </div>
            ...
            {[
              {
                ...
                content:
                  "The quality of the products exceeded my expectations. Fast shipping and excellent customer service made this a perfect shopping experience!",
                rating: 5,
                image:
              ...
              },
              {
                ...
                role: "Style Blogger",
                content:
                  "I've tried several online retailers, but this store stands out for their quality and selection. The customer service team is outstanding!",
                rating: 5,
                image:
              ...
              },
              {
                ...
                content:
                  "The fit and finish of their garments are top-notch. I've recommended this store to all my followers and friends.",
                rating: 5,
                image:
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Special deals for our newsletter subscribers. Join now to get
              ...
              >
                <div className="aspect-[4/3] relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6">
                    ...
                    <p className="text-3xl font-bold text-yellow-300 my-2">
                      {offer.discount}
                    </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <div className="mb-10">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Subscribe to our newsletter and be the first to get exclusive
              access to new collections, special offers, style tips and
          ...
          <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto items-center justify-center">
            <div className="relative flex-1 min-w-[300px]">
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 text-gray-400 absolute left-5 top-1/2 transform -translate-y-1/2"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
