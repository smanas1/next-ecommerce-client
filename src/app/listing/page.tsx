    ...
    return (
      <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-6">
        ...
        <div>
          <h3 className="mb-3 font-semibold text-gray-800 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
              <path d="M20 21v-8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 4 13v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 20 21z"/>
            </svg>
            Brands
          </h3>
          <div className="space-y-2">
        ...
        <div>
          <h3 className="mb-3 font-semibold text-gray-800 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
              ...
              <path d="m3 14 2.5-2.5L3 9"/>
              <path d="m21 6-2.5 2.5L21 11"/>
            </svg>
            Size
          </h3>
